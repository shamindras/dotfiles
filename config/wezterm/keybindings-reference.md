...
Source of truth: `utils/keybindings.lua`. Update this file whenever bindings change.
...
All tmux bindings send prefix `C-a` followed by the tmux key. Key-table bindings send prefix + table key + action key
(e.g., `C-a O g` for lazygit).
